...
define i32 @_Z4fun1cPi(i8 signext %cond, i32* %p) #0 {
entry:
...
; Function Attrs: noinline nounwind uwtable
define i32 @_Z4fun2cPi(i8 signext %cond, i32* %p) #0 {
entry:
  %cond.addr = alloca i8, align 1
  %p.addr = alloca i32*, align 8
  store i8 %cond, i8* %cond.addr, align 1
...
if.then2:                                         ; preds = %if.then
  ...
  %call = call i32 @_Z4fun1cPi(i8 signext %2, i32* %3)
...
if.else:                                          ; preds = %if.then
  ...
  %call3 = call i32 @_Z4fun2cPi(i8 signext %4, i32* %5)
