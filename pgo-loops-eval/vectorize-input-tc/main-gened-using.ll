...
for.body:                                         ; preds = %for.body.for.body_crit_edge, %for.body.lr.ph
  %indvars.iv = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next, %for.body.for.body_crit_edge ], [ %indvars.iv.next, %for.body ]
  ...
  br i1 %cmp, label %for.body, label %for.cond.cleanup.loopexit, !prof !36
